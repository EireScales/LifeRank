    ...
    <main className="mx-auto min-h-screen w-full max-w-md px-4 py-6 text-slate-900">
        ...
        <section className="animate-rise space-y-4">
          ...
          <Card>
            ...
            <div className="mt-4 grid grid-cols-1 gap-2 text-sm sm:grid-cols-3">
              <button onClick={onCopyResult} className="rounded-xl bg-slate-100 px-3 py-2 font-medium text-slate-800">Copy Result</button>
      ...
      {stage === "dashboard" && (
        <section className="animate-rise space-y-4 pb-6">
          ...
          <Card>
            <h3 className="text-lg font-semibold">LifeRank Timeline</h3>
            <div className="mt-4 space-y-2 text-sm text-slate-700">
